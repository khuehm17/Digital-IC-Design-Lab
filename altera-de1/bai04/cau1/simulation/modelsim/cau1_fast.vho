...
SIGNAL \comb_3|m~0_combout\ : std_logic;
SIGNAL \comb_4|q~regout\ : std_logic;
...
-- Equation(s):
-- \comb_3|m~0_combout\ = (\SW~combout\(2) & (\SW~combout\(1))) # (!\SW~combout\(2) & ((\SW~combout\(0))))
...
\comb_4|q\ : cycloneii_lcell_ff
PORT MAP (
	clk => \KEY~combout\(0),
	datain => \comb_3|m~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
