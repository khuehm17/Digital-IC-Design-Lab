...
SIGNAL \comb_3|d~0_combout\ : std_logic;
...
\comb_3|d~0\ : cycloneii_lcell_comb
-- Equation(s):
-- \comb_3|d~0_combout\ = (\comb_3|comb_8|q~regout\ & (!\SW~combout\(1))) # (!\comb_3|comb_8|q~regout\ & ((\SW~combout\(0))))
