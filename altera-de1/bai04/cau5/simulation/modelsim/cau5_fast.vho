...
-- Equation(s):
-- \comb_3|q~0_combout\ = (\KEY~combout\(1) & \SW~combout\(0))
...
\comb_4|q~0\ : cycloneii_lcell_comb
-- Equation(s):
-- \comb_4|q~0_combout\ = (\KEY~combout\(1) & \comb_3|q~regout\)
...
-- Equation(s):
-- \comb_5|q~0_combout\ = (\KEY~combout\(1) & \comb_4|q~regout\)
...
-- Equation(s):
-- \comb_6|q~0_combout\ = (\KEY~combout\(1) & \comb_5|q~regout\)
