...
SIGNAL \comb_3|bcd[1]~1_combout\ : std_logic;
SIGNAL \comb_3|bcd[2]~2_combout\ : std_logic;
SIGNAL \comb_3|bcd[3]~3_combout\ : std_logic;
SIGNAL \comb_3|bcd[3]~4_combout\ : std_logic;
...
-- Equation(s):
-- \comb_3|bcd[0]~0_combout\ = \comb_3|bcd\(0) $ (\SW~combout\(0))
...
\comb_3|bcd[1]~1\ : cycloneii_lcell_comb
-- Equation(s):
-- \comb_3|bcd[1]~1_combout\ = \comb_3|bcd\(1) $ (((\SW~combout\(0) & \comb_3|bcd\(0))))
...
PORT MAP (
	...
	datac => \comb_3|bcd\(1),
	datad => \comb_3|bcd\(0),
	combout => \comb_3|bcd[1]~1_combout\);

-- Location: LCFF_X7_Y14_N15
\comb_3|bcd[1]\ : cycloneii_lcell_ff
PORT MAP (
	clk => \KEY~combout\(0),
	datain => \comb_3|bcd[1]~1_combout\,
	aclr => \ALT_INV_KEY~combout\(1),
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	regout => \comb_3|bcd\(1));
...
\comb_3|bcd[2]~2\ : cycloneii_lcell_comb
-- Equation(s):
-- \comb_3|bcd[2]~2_combout\ = \comb_3|bcd\(2) $ (((\comb_3|bcd\(1) & (\SW~combout\(0) & \comb_3|bcd\(0)))))
...
PORT MAP (
	...
	datac => \comb_3|bcd\(2),
	datad => \comb_3|bcd\(0),
	combout => \comb_3|bcd[2]~2_combout\);

-- Location: LCFF_X7_Y14_N29
\comb_3|bcd[2]\ : cycloneii_lcell_ff
PORT MAP (
	clk => \KEY~combout\(0),
	datain => \comb_3|bcd[2]~2_combout\,
	aclr => \ALT_INV_KEY~combout\(1),
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	regout => \comb_3|bcd\(2));
...
\comb_3|bcd[3]~3\ : cycloneii_lcell_comb
-- Equation(s):
-- \comb_3|bcd[3]~3_combout\ = (\SW~combout\(0) & (\comb_3|bcd\(1) & (\comb_3|bcd\(0) & \comb_3|bcd\(2))))
...
PORT MAP (
	...
	datac => \comb_3|bcd\(0),
	datad => \comb_3|bcd\(2),
	combout => \comb_3|bcd[3]~3_combout\);

-- Location: LCCOMB_X7_Y14_N26
\comb_3|bcd[3]~4\ : cycloneii_lcell_comb
-- Equation(s):
-- \comb_3|bcd[3]~4_combout\ = \comb_3|bcd\(3) $ (\comb_3|bcd[3]~3_combout\)
...
PORT MAP (
	datac => \comb_3|bcd\(3),
	datad => \comb_3|bcd[3]~3_combout\,
	combout => \comb_3|bcd[3]~4_combout\);

-- Location: LCFF_X7_Y14_N27
\comb_3|bcd[3]\ : cycloneii_lcell_ff
PORT MAP (
	clk => \KEY~combout\(0),
	datain => \comb_3|bcd[3]~4_combout\,
	aclr => \ALT_INV_KEY~combout\(1),
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	regout => \comb_3|bcd\(3));
...
-- Equation(s):
-- \comb_4|WideOr6~0_combout\ = (\comb_3|bcd\(3) & (\comb_3|bcd\(0) & (\comb_3|bcd\(1) $ (\comb_3|bcd\(2))))) # (!\comb_3|bcd\(3) & (!\comb_3|bcd\(1) & (\comb_3|bcd\(2) $ (\comb_3|bcd\(0)))))
...
-- Equation(s):
-- \comb_4|WideOr5~0_combout\ = (\comb_3|bcd\(1) & ((\comb_3|bcd\(0) & (\comb_3|bcd\(3))) # (!\comb_3|bcd\(0) & ((\comb_3|bcd\(2)))))) # (!\comb_3|bcd\(1) & (\comb_3|bcd\(2) & (\comb_3|bcd\(3) $ (\comb_3|bcd\(0)))))
...
-- Equation(s):
-- \comb_4|WideOr4~0_combout\ = (\comb_3|bcd\(3) & (\comb_3|bcd\(2) & ((\comb_3|bcd\(1)) # (!\comb_3|bcd\(0))))) # (!\comb_3|bcd\(3) & (\comb_3|bcd\(1) & (!\comb_3|bcd\(2) & !\comb_3|bcd\(0))))
...
-- Equation(s):
-- \comb_4|WideOr3~0_combout\ = (\comb_3|bcd\(1) & ((\comb_3|bcd\(2) & ((\comb_3|bcd\(0)))) # (!\comb_3|bcd\(2) & (\comb_3|bcd\(3) & !\comb_3|bcd\(0))))) # (!\comb_3|bcd\(1) & (!\comb_3|bcd\(3) & (\comb_3|bcd\(2) $ (\comb_3|bcd\(0)))))
...
-- Equation(s):
-- \comb_4|WideOr2~0_combout\ = (\comb_3|bcd\(1) & (!\comb_3|bcd\(3) & ((\comb_3|bcd\(0))))) # (!\comb_3|bcd\(1) & ((\comb_3|bcd\(2) & (!\comb_3|bcd\(3))) # (!\comb_3|bcd\(2) & ((\comb_3|bcd\(0))))))
...
-- Equation(s):
-- \comb_4|WideOr1~0_combout\ = (\comb_3|bcd\(1) & (!\comb_3|bcd\(3) & ((\comb_3|bcd\(0)) # (!\comb_3|bcd\(2))))) # (!\comb_3|bcd\(1) & (\comb_3|bcd\(0) & (\comb_3|bcd\(3) $ (!\comb_3|bcd\(2)))))
...
-- Equation(s):
-- \comb_4|WideOr0~0_combout\ = (\comb_3|bcd\(0) & ((\comb_3|bcd\(3)) # (\comb_3|bcd\(1) $ (\comb_3|bcd\(2))))) # (!\comb_3|bcd\(0) & ((\comb_3|bcd\(1)) # (\comb_3|bcd\(3) $ (\comb_3|bcd\(2)))))
